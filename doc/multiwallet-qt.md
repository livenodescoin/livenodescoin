...
In order to support loading of multiple wallets in livenodes-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is livenodes.cpp.
...
Changes to livenodes.cpp
----------------------
livenodes.cpp is the entry point into livenodes-qt, and as such, will require some minor modifications to provide hooks for
