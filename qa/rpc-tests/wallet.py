...
#   c) node1 mines 32 blocks, so now node 0 has 60001livenodes, node 1 has 4250livenodes, node2 has none.
#   d) node0 sends 601 livenodes to node2, in two transactions (301 livenodes, then 300 livenodes).
