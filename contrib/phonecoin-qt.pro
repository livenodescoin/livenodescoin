...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/livenodes-cli.cpp \
           src/livenodes-tx.cpp \
           src/livenodes.cpp \
           src/db.cpp \
           ...
           src/qt/livenodes.cpp \
           src/qt/livenodesstrings.cpp \
...
RESOURCES += src/qt/livenodes.qrc src/qt/livenodes_locale.qrc

TRANSLATIONS += src/qt/locale/livenodes_bg.ts \
                src/qt/locale/livenodes_de.ts \
                src/qt/locale/livenodes_en.ts \
                src/qt/locale/livenodes_es.ts \
                src/qt/locale/livenodes_fi.ts \
                src/qt/locale/livenodes_fr.ts \
                src/qt/locale/livenodes_it.ts \
                src/qt/locale/livenodes_ja.ts \
                src/qt/locale/livenodes_pl.ts \
                src/qt/locale/livenodes_pt.ts \
                src/qt/locale/livenodes_ru.ts \
                src/qt/locale/livenodes_sk.ts \
                src/qt/locale/livenodes_sv.ts \
                src/qt/locale/livenodes_vi.ts \
                src/qt/locale/livenodes_zh_CN.ts \
                src/qt/locale/livenodes_zh_TW.ts
