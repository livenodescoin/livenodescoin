...
int64_t GetSporkValue(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_9_POSV3_VULNERABILITYPATCH) r = SPORK_9_POSV3_VULNERABILITYPATCH_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_9_POSV3_VULNERABILITYPATCH") return SPORK_9_POSV3_VULNERABILITYPATCH;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if (id == SPORK_9_POSV3_VULNERABILITYPATCH) return "SPORK_9_POSV3_VULNERABILITYPATCH";
