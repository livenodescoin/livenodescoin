...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::LNO);
...
// Wallet
    ...
    if (settings.contains("nAnonymizePhcAmount"))
        SoftSetArg("-anonymizelivenodesamount", settings.value("nAnonymizePhcAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in livenodes.cpp during shotdown to also remove the window positions
