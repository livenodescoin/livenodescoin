...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("LivenodesCoin Core"),
     ...
     * override -datadir in the livenodes.conf file in the default data directory
     * (to be consistent with livenodesd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
