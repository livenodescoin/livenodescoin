/* src/config/livenodes-config.h.  Generated from livenodes-config.h.in by configure.  */
/* src/config/livenodes-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef LivenodesCoin_CONFIG_H

#define LivenodesCoin_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.livenodes.net"

/* Define to the full name of this package. */
#define PACKAGE_NAME "LivenodesCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "LivenodesCoin Core 1.0.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "livenodes"
