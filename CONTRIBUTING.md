Contributing to LivenodesCoin Core
============================

The LivenodesCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the LivenodesCoin Core project, and is not to be
confused with overall LivenodesCoin Network Protocol consensus changes.

Whether a pull request is merged into LivenodesCoin Core rests with the project merge
...
Patches that change LivenodesCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the LivenodesCoin consensus, it must have been
...
The project leader is the release manager for each LivenodesCoin Core release.
